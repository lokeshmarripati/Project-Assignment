...
import './QuestionsAttempt.css';  // Import the CSS file for styling
...
const QuestionsAttempt = () => {
    ...
    if (score !== null) {
        return (
            <div className="score-container">
                ...
                <button className="exit-button"><Link to='/user-login'>Exit</Link></button>
            </div>
        );
    }
    ...
    return (
        <div className="questions-container">
            <h2 className="heading">Attempt Questions for {technology}</h2>
            {questions.length === 0 ? (
